...
<link  rel="stylesheet" href="css/bootstrap.min.css"/>
 ...
 <style>
  .changinguser{
    color: red;
      animation-name: rightToLeft22;
      animation-duration: 8s;
      animation-timing-function: linear;
      animation-iteration-count: infinite;
  }
  @keyframes rightToLeft22 {
    0% {
...
<div class="header">
<div class="row">
<div class="col-lg-6 onexe">
<span class="logo ">Online Examination System</span></div>
<div class="col-md-2 col-md-offset-4">
<a href="#" class="pull-right btn sub1 w3-center w3-animate-right" style="border-radius:0%" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Login</b></span></a></div>
<!--sign in modal start-->
  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <h4 class="modal-title title1 text-center changinguser"><span style="color:black"><b>USER LOGIN</b></span></h4>
      </div>
...
<fieldset class="fieldsetmove w3-container w3-center w3-animate-left">
...
<div class="col-md-4 set-position">
<button onclick="typeWriter()"><h3 class="w3-container w3-center w3-animate-left">Objectives</h3></button>
...
<a href="#" data-toggle="modal" class="w3-center w3-animate-top" data-target="#login"><i class="fa-solid fa-user"></i>&nbsp;Admin Login</a></div>
<div class="col-md-4 box">
<a href="#" data-toggle="modal" data-target="#developers"><i class="fa-sharp fa-solid fa-brackets-curly"></i>Developers</a>
</div>
<div class="col-md-4 box">
<a href="feedback.php" target="_blank"><i class="fa-duotone fa-comments"></i>&nbsp;Feedback</a></div></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/DEV.jpg" width=80 height=80 alt="Abdullah Al Naseeh Chowdhury" class="img-rounded">
     <img src="image/DEV.jpg" width=80 height=80 alt="Syme Al-Azad Shuvo" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Abdullah Al Naseeh Chowdhury Syme Al-Azad Shuvo</a>
		
		
		<h4 style="font-family:'typo' ">Sylhet Engineering College</h4></div></div>
		</p>
      </div>
...
<!--Modal for admin login-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title onexe2"><span style="color:black;font-family:'typo' "><center>ADMIN LOGIN</center></span></h4>
      </div>
